...
description: "The Agentic Application Framework:  Build custom AI copilots for any agent, model or modality."
...
CopilotKit is the **open source toolkit and hosted service** for building smarter, more natural, and more useful applications — powered by the collaboration of three forms of intelligence:

- The **encoded intelligence** of your application logic
- The **adaptive intelligence** of LLMs and agent frameworks
- The **creative intelligence** of your real human users

CopilotKit connects your app’s **logic, state, and user context** to the **AI agents** that deliver the animated and interactive part of your app experience — across both embedded UIs and fully headless interfaces. It gives developers the tools to build, deploy, and monitor AI-assisted features that feel intuitive, helpful, and deeply integrated.
