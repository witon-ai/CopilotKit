...
export function LinkToCopilotCloud({
  ...
  if (asButton) {
    cn = "text-indigo-800 dark:text-indigo-300 ring-1 ring-indigo-200 dark:ring-indigo-900 text-sm items-center bg-gradient-to-r from-indigo-200/50 to-purple-200/80 dark:from-indigo-900/40 dark:to-purple-900/50 flex p-3 px-4 transition-all duration-100 hover:ring-2 hover:ring-indigo-400 hover:dark:text-indigo-200 rounded-lg no-underline";
  } else {
  ...
  return (
    ...
    >
      ...
      {
        children ? children : userId ? "Go to CopilotKit Platform" : "Sign up for CopilotKit Platform"
      }
    </Link>
  );
}